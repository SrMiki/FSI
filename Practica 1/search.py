...
def tree_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            #Si hemos llegado imprimimos el contador (nodos recorridos)
            print count
            return node
...
""" Si usamos tree visitara mas nodos porque tree no elimina los nodos ya visitados
     en cambio grafos si que los cierra. Daran la misma solucion"""
def ramiAcota_first_graph_search(problem):
    return graph_search(problem, RamiQueue())

def ramiAcotaSub_first_graph_search(problem):
    return graph_search(problem, RamiSubQueue(problem))
#______________________________________________________________________________
